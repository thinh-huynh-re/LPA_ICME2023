...
def get_backbone(args):
    ...
    elif model_name == "resnet18_scs":
        model = resnet18_scs()
    elif model_name == "resnet18_scs_avg":
        model = resnet18_scs_max()
    elif model_name == "resnet18_scs_max":
        model = resnet18_scs_avg()
...
def get_loaders(dataset_train, dataset_val, args):
    ...
    actual_batch_size = (
        args.batch_size // utils.get_world_size() * 2
    )  # default 2 gpus and 128*2 batchsize
