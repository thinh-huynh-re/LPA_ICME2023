...
def add_rc(parser: ArgumentParser):
    parser.add_argument(
        "--configs", nargs="*", type=Path, help="yaml config files to load.", default=[]
    )
    ...
    # device
    parser.add_argument(
        "--device", type=str, default="cuda", help='support "cpu" and "cuda".'
    )
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="auto resume from checkpoint directory",
    )
...
def add_sc(parser: ArgumentParser):
    ...
    parser.add_argument(
        "--base-epochs", default=500, type=int, help="Number of epochs for base task"
    )
    parser.add_argument(
        "--no-amp", default=False, action="store_true", help="Disable mixed precision"
    )
    ...
    parser.add_argument(
        "--distillation-tau", default=1.0, type=float, help="Temperature for the KD"
    )
    parser.add_argument("--kd-factor", default=1.0)
    ...
    parser.add_argument(
        "--initial-increment", default=50, type=int, help="Base number of classes"
    )
    parser.add_argument(
        "--increment",
        default=10,
    ...
    parser.add_argument(
        "--max-task", default=None, type=int, help="Max task id to train on"
    )
    ...
    parser.add_argument(
        "--only-ft", default=False, action="store_true", help="Only train on FT data"
    )
    ...
    # Convit - CaiT
    parser.add_argument(
        "--local-up-to-layer", default=10, type=int, help="number of GPSA layers"
    )
    parser.add_argument(
        "--locality-strength",
        default=1.0,
    ...
    parser.add_argument(
        ...
        default=0.1,
        type=float,
        help="Relation distillation loss impact in final loss",
    )
