...
class SharpenedCosineSimilarity(nn.Module):
    ...
    def forward(self, x):
        ...
        x_norm = torch.add(
            torch.sqrt(square_sum + self.eps), torch.square(self.q / self.q_scale)
        )
...
def conv3x3(
    ...
    return SharpenedCosineSimilarity(
